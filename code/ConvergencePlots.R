...
W_results = readRDS("ZL_results2_bar180.RDS")
...
convergencePlot_catMuScatter = function(res, pnum, whichIterations=NULL) {
  ...
  for (j in 1:dim(cmi)[1]) {
    ...
    cmij = clampAngle_R(cmij, pm180 = FALSE)
...
#convergencePlots(W_results, filename="plots2.pdf", whichIterations=NULL) 
convergencePlots(W_results, filename="plots3.pdf", whichIterations=NULL) 
